...
public class SimulinkLine extends AbstractResource{
	...
	@OslcName("sourcePort")
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Line/sourcePort")
	@OslcTitle("sourcePort")
	@OslcRange("http://mathworks.com/simulink/rdf#Port")
	...
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Line/targetPort")
