...
public class SimulinkModel extends AbstractResource{
	...
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Model/name")
	@OslcTitle("name")
	...
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Model/block")
	@OslcTitle("block")
	@OslcReadOnly(false)
	...
	@OslcName("line")
	@OslcOccurs(Occurs.ZeroOrMany)
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Model/line")
	@OslcTitle("line")
	@OslcReadOnly(false)
