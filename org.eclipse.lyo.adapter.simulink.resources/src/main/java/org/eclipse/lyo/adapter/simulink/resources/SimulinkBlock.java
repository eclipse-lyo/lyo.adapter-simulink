...
public class SimulinkBlock extends AbstractResource{
	...
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Block/name")
	@OslcTitle("name")
	...
	@OslcName("type")
	@OslcOccurs(Occurs.ZeroOrOne)
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Block/type")
	@OslcTitle("type")
	@OslcValueType(ValueType.XMLLiteral)
	...
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Block/inputPort")
	@OslcTitle("inputPort")
	@OslcReadOnly(false)
	...
	@OslcName("outputPort")
	@OslcOccurs(Occurs.ZeroOrMany)
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Block/outputPort")
	...
	@OslcName("parameter")
	@OslcOccurs(Occurs.ZeroOrMany)
	@OslcPropertyDefinition("http://mathworks.com/simulink/rdf#Block/parameter")
	@OslcTitle("parameter")
	@OslcReadOnly(false)
