...
<title>Simulink OSLC Adapter: Simulink Output Port</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Simulink OSLC Adapter: Simulink Output Port</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Simulink Output Port </span><%= element.getId() %></h1>
		<br>
