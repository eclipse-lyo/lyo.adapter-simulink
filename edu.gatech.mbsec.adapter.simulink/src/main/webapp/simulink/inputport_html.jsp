...
<%
SimulinkInputPort element = (SimulinkInputPort)request.getAttribute("element");
if (element == null) {
	response.sendError(HttpServletResponse.SC_NOT_FOUND, "Simulink Input Port not found");
	return;
}
...
<title>Simulink OSLC Adapter: Simulink Input Port</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Simulink OSLC Adapter: Simulink Input Port</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Simulink Input Port </span><%= element.getId() %></h1>
		<br>

		<!-- resource attributes and relationships -->
		<p><span id="metainfo">ID</span>: <%= element.getId() %></p>
