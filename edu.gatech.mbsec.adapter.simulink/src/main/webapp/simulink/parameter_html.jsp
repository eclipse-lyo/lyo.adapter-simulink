...
<title>Simulink OSLC Adapter: Simulink Parameter</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Simulink OSLC Adapter: Simulink Parameter</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Simulink Parameter </span><%= element.getName() %></h1>
		<br>

		<!-- resource attributes and relationships -->
		<p><span id="metainfo">Name</span>: <%= element.getName() %></p>
		<p><span id="metainfo">Value</span>: <%= element.getValue() %></p>
