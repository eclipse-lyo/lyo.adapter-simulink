...
public class ServiceProviderCatalogService
	...
	private static final Logger LOG = LoggerFactory.getLogger(ServiceProviderCatalogService.class);
    ...
    public void getHtmlServiceProvider(@PathParam("serviceProviderId") final String serviceProviderId)
    {
    	...
    	{	        
	        ...
	        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/simulink/serviceprovidercatalog_html.jsp");
    		try {
