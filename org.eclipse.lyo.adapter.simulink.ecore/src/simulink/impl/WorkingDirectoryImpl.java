 ...
 * <ul>
 *   <li>{@link simulink.impl.WorkingDirectoryImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkingDirectoryImpl extends MinimalEObjectImpl.Container implements WorkingDirectory {
	...
	protected EClass eStaticClass() {
		return SimulinkPackage.Literals.WORKING_DIRECTORY;
	}
	...
	public EList<Model> getModel() {
		if (model == null) {
			model = new EObjectContainmentEList<Model>(Model.class, this, SimulinkPackage.WORKING_DIRECTORY__MODEL);
		}
		return model;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimulinkPackage.WORKING_DIRECTORY__MODEL:
