 ...
 * <ul>
 *   <li>{@link simulink.impl.ModelImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link simulink.impl.ModelImpl#getLine <em>Line</em>}</li>
 *   <li>{@link simulink.impl.ModelImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	public EList<Block> getBlock() {
		if (block == null) {
			block = new EObjectContainmentEList<Block>(Block.class, this, SimulinkPackage.MODEL__BLOCK);
		}
		return block;
	}
	...
	public EList<Line> getLine() {
		if (line == null) {
			line = new EObjectContainmentEList<Line>(Line.class, this, SimulinkPackage.MODEL__LINE);
		}
		return line;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimulinkPackage.MODEL__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimulinkPackage.MODEL__BLOCK:
				return ((InternalEList<?>)getBlock()).basicRemove(otherEnd, msgs);
			case SimulinkPackage.MODEL__LINE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SimulinkPackage.MODEL__LINE:
				return getLine();
			case SimulinkPackage.MODEL__NAME:
				return getName();
		}
