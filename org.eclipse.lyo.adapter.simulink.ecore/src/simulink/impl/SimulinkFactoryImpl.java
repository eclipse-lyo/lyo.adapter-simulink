...
public class SimulinkFactoryImpl extends EFactoryImpl implements SimulinkFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SimulinkPackage.WORKING_DIRECTORY: return createWorkingDirectory();
			...
			case SimulinkPackage.PORT: return createPort();
			case SimulinkPackage.INPUT_PORT: return createInputPort();
			case SimulinkPackage.OUTPUT_PORT: return createOutputPort();
