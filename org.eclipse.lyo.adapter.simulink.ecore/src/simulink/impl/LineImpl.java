 ...
 * <ul>
 *   <li>{@link simulink.impl.LineImpl#getSourcePort <em>Source Port</em>}</li>
 *   <li>{@link simulink.impl.LineImpl#getTargetPort <em>Target Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineImpl extends MinimalEObjectImpl.Container implements Line {
	 ...
	 * @ordered
	 */
	protected EList<Port> targetPort;
	 ...
	 * @generated
	 */
	public EList<Port> getTargetPort() {
		if (targetPort == null) {
			targetPort = new EObjectResolvingEList<Port>(Port.class, this, SimulinkPackage.LINE__TARGET_PORT);
		}
		return targetPort;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimulinkPackage.LINE__TARGET_PORT:
				getTargetPort().clear();
				getTargetPort().addAll((Collection<? extends Port>)newValue);
				return;
		}
